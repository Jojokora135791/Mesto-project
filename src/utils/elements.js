...
export const popupEditProfileForm = document.querySelector(".popup__form[name=profile]");
export const popupAddAuthorForm = document.querySelector(".popup__form[name=place]");
export const popupEditAvatarForm = document.querySelector(".popup__form[name=avatar]");

export const popupEditAvatarInput = document.querySelector(".popup__input[name=avatar]");
